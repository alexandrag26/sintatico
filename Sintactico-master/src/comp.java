...
class comp/*@bgen(jjtree)*/implements compTreeConstants, compConstants {/*@bgen(jjtree)*/
  ...
  public void Principal( String argumento)throws ParseException, Exception
        {
                try
                {
                    InputStream stream = new ByteArrayInputStream(argumento.getBytes(StandardCharsets.UTF_8));
                    System.out.println("BIENVENIDO");
                    comp analizador = new comp( stream ) ;
                        analizador.Programa();
                        System.out.println("No se han detectado errores. Analizado con exito");
                        System.out.println("Imprimiendo arbol sintactico.");
                }
                catch(ParseException e)
                {
                        System.out.println(e.getMessage());
                        System.out.println("\u005ctAnalizador ha detectado error.");
                }
 ...
 /*@bgen(jjtree) SWITCH */
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x4000000,0x1000,0x300,0x0,0x0,0x2,0x0,0x2,0x3c,0x3c64000,0xc24000,0x3040000,0x18000,0x18000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3c,0x0,0x0,0x2,0xc00000,0xc0,0xc2,0x0,0x0,0x4,0x4,0x0,0x0,0x0,0x80000,0x200000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x1e000,0x4,0x0,0x4,0x0,0x3e0000,0x5e000,0x1e000,0x0,0x0,0x0,0x61800,0x1800,0x1800,0x60000,0x60000,0x60000,0x60000,0x60000,0x60000,0x7e0,0x0,0x1e000,0x5e000,0x0,0x0,0x0,0x0,0x3e0000,0x160000,0x0,0x0,0x160000,0x3e0000,0x40000,0x0,0x0,};
   }
